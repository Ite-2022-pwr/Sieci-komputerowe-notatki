...
- [EtherChannel - agregacja łączy](./sieci_notatki/EtherChannel.md)
- [Adresy IPv6 (ściągawka)](./sieci_notatki/Adresy_IPv6.md)
- [Protokoły dynamicznej konfiguracji hosta](./sieci_notatki/Dynamiczna_konfiguracja_hosta.md)
- [Redundancja routera pierwszego przeskoku - FHRP](./sieci_notatki/fhrp.md)
- [Bezpieczeństwo sieci LAN](./sieci_notatki/Bezpieczenstwo_LAN.md) - **IN PROGRESS**
